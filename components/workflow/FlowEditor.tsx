        ...
        (event: React.DragEvent) => {
            ...
            if (type === "textNode") {
                ...
                newNode = {
                    ...
                    type: "videoNode",
                    position,
                    data: { label: "Video Input", status: "idle", inputType: "upload" }
                };
                ...
                newNode = {
                    ...
                    type: "cropImageNode",
                    position,
                    data: { label: "Crop Image", status: "idle", x: 0, y: 0, width: 100, height: 100 }
                };
                ...
                newNode = {
                    ...
                    position,
                    data: { label: "Extract Frame", status: "idle", timestamp: "00:00:01" }
                };
            } else {
                newNode = {
                    id: newNodeId,
